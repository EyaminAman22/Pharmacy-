    ...
    <div class="flex">
        ...
        <div class="w-2/5 bg-indigo h-[790px]">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'];?>" class="bg-white flex flex-col w-3/5 rounded-3xl gap-y-5 p-[50px] text-center mx-auto my-[200px]" method = "POST">
                ...
                <input class="w-[300px] h-[40px] rounded-xl outline outline-1" type="text" placeholder="  User Name" name = "">

                <input class="w-[300px] h-[40px] rounded-xl outline outline-1" type="password" placeholder="  Password" name = "">

                <input class="text-white text-24 font-semibold bg-indigo w-[120px] p-2 rounded-xl place-self-center ease-in duration-300 hover:bg-white hover:text-indigo hover:focus:ring hover:focus:border-blue-500 hover:outline" type="submit" placeholder="Login" name = "">
                <br>
                 <span>
                    <?php
