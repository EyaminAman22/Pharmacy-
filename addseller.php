<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(empty($pname)){
            $error['pname'] = 'Please write the Seller Name';
        }
        if(empty($pass)){
            $error['pass'] = 'Please write the password';
        }
        if(empty($mobile)){
            $error['mobile'] = 'Please write the mobile number';
        }
        if(empty($address)){
            $error['address'] = 'Please write the Address';
        }

        if(count($error)==0){

            $insert = "INSERT INTO providerlogin(username,password,mobile,address) VALUES ('$pname','$pass','$mobile','$address')";
        ...
        <i class="fa-solid fa-user text-white text-[100px]"></i>
            <nav class="">
                <ul class="flex pt-10 flex-col text-20">
                    ...
                    <a href="deliverydetails.php"><li class="block  hover:bg-li-navy hover:ease-in py-3 ease-out duration-400">Delivery Man Details</li></a>
    ...
    <div class="w-4/5">
        ...
        <div class="bg-navy mx-48 my-24 py-10 rounded-3xl text-white">
            ...
            <div class="text-20">
               ...
               <input class="w-96 ml-72 rounded-2xl" name="pname" placeholder="  Provider Name"type="text" >
               <input class="w-96 ml-72 rounded-2xl" name="pass" placeholder="  E-mail"type="email">
                <input class="w-96 ml-72 rounded-2xl" name="mobile" placeholder="  Phone No..." type="number" >
