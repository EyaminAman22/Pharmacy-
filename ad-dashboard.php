    ...
    <div class="w-4/5">
        ...
        <div class="flex p-5 justify-around pt-28">
            <div class="block bg-navy text-center rounded-2xl hover:bg-li-navy hover:ease-in py-4 ease-out duration-400 p-5">
                <h4 class="text-white text-20 font-semibold pt-2">number of Sellers: </h4>
            </div>
            <div class="block bg-navy text-center rounded-2xl hover:bg-li-navy hover:ease-in py-4 ease-out duration-400 p-5">
                <h4 class="text-white text-20 font-semibold pt-2">number of Customers: </h4>
            </div>
            <div class="block bg-navy text-center rounded-2xl hover:bg-li-navy hover:ease-in py-4 ease-out duration-400 p-5">
                <h4 class="text-white text-20 font-semibold pt-2">number of Delivery Man: </h4>
            </div>
        </div>
        ...
        <a href="addseller.php">
            <div class="block bg-navy text-center rounded-2xl hover:bg-li-navy hover:ease-in py-4 ease-out duration-400 p-5">
                ...
                <h4 class="text-white text-20 font-semibold pt-2">Add Seller</h4>
            </div>
        </a>
